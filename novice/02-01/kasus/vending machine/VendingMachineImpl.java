...
public class VendingMachineImpl implements VendingMachine {
    ...
    public void insertCoin(Coin coin) {
        currentBalance = currentBalance + coin.getDomination();
    ...
    public Bucket<Item, List<Coin>> collectItemAndChange() {
        ...
        return new Bucker<item, List<Coin>>(item, change);
    }
    ...
    private List<Coin> getChange(long amount) throws NotSufficientChangeException {
        ...
        if (amount > 0) {
            ...
            long balance = amount;
            while (balance > 0) {
                if (balance >= Coin.QUARTER.getDomination() && cashInventory.hasItem(Coin.QUARTER)) {
    ...
    private boolean hasSufficientChange() {
        return hasSuffcientChangeForAmount(currentBalance - current.getPrice());
